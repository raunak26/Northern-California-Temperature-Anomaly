...
if filename == "Sacramento-1880-2018.NOAA.csv": # if and else statement
    infile = open("Sacramento-1880-2018.NOAA.csv", "r") # information input from Sacramento-1880-2018.NOAA.csv
